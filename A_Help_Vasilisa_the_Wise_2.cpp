...
bool correct(int a1, int a2,int b1,int b2, int r1, int r2, int c1 , int c2, int d1, int d2)
{
    bool f = ((a1+a2) ==r1 ) && ((b1+b2) ==r2) && ((a1+b1) ==c1) && ((a2+b2) == c2) && ((a1+b2) ==d1) && ((b1+a2) == d2);
    return f;
}
...
void solve() {
    ...
    for(int i =1; i <= 9; i++){
        for(int j = 1; j <= 9  ; j++){
            for(int k =1; k <=9; k++){
                for(int q = 1; q<=9; q++){
                    if((i!=j) && (j!=k) && (k!=q) && (i!=q && i!=k) && (j != q))
                    {
                        if(correct(i,j,k,q,r1,r2,c1,c2,d1,d2)){
                            cout << i << " " << j <<endl;
                            cout << k << " " << q<< endl;
                            return;
                        }
