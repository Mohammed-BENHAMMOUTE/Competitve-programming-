    ...
    static Point rotate_point(double x, double y, double cx, double cy, double angle) {
    ...
    static pair<double, double> min_enclosing_rectangle(const vector<vector<double>>& rectangles,double &maxwidth,double &maxheight) {
